# LANCEMENT :
# Terminal anaconda puis aller sur le repertoire du fichier a lancer : cd nom_du_repertoire
# uvicorn projet_7_4_API:app --reload
# http://127.0.0.1:8000
# ou
...
def welcome():
    ...
    """
    return 'Bienvenue sur le projet : Implémentez un modèle de scoring'
